    ...
    def optimize_lineup(self,
        ...
        if cache_key in self._lineup_cache:
            ...
            if (datetime.now() - cache_time).seconds < 300:  # 5 min cache
                logger.info("PERFORMANCE: Caching disabled for ML testing")
...
if __name__ == "__main__":
    ...
    print("📋 Usage:")
    print("   from dfs_optimizer.core.unified_milp_optimizer import UnifiedMILPOptimizer, OptimizationConfig")
