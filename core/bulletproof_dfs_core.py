...
from core.optimal_lineup_optimizer import OptimalLineupOptimizer, OptimizationResult

warnings.filterwarnings('ignore')

# Enhanced Statistical Analysis Engine - PRIORITY 1 IMPROVEMENTS
try:
    from data_sources.enhanced_stats_engine import apply_enhanced_statistical_analysis
...
try:
    from data_sources.vegas_lines import VegasLines
...
try:
    from data_sources.simple_statcast_fetcher import SimpleStatcastFetcher
