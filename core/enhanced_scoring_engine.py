...
class EnhancedScoringEngine:
    ...
    def load_optimized_parameters(self):
        ...
        self.cash_params = {
            # Weight distribution
            'weight_projection': 0.3773595675092053,
            'weight_recent': 0.36931183387251365,
            'weight_season': 0.1890108257960834,
    ...
    def score_player_cash(self, player) -> float:
        ...
        season_score = projection_score * 0.9  # Slightly lower than projection
        ...
        if self.cash_params['consistency_method'] == 'both':
            ...
            consistency_factor = 1.0 - (self.cash_params['consistency_weight'] * 0.2)  # Reduce by up to 20%
        ...
        floor = base_score * 0.7  # Conservative floor estimate
